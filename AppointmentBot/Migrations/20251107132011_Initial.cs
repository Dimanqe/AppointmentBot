    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Masters",
                columns: new[] { "Id", "Bio", "Name", "TelegramLink" },
                values: new object[,]
                {
                    { 1, null, "Арина", null },
                    { 2, null, "Лиля", null }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, true, "Классическое наращивание", 0m },
                    { 2, 0, true, "Объемное наращивание 2D", 0m },
                    { 3, 0, true, "Объемное наращивание 3D", 0m },
                    { 4, 0, true, "Объемное наращивание 4D", 0m },
                    { 5, 0, true, "Объемное наращивание \"батерфлай\"", 0m },
                    { 6, 0, true, "Объемное наращивание \"американка\"", 0m },
